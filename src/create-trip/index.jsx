...
const MapboxAutocomplete = ({ onchange }) => {
  ...
  useEffect(() => {
    ...
    geocoderRef.current.on("result", (event) => {
      ...
      if (inputField) inputField.value = event.result.place_name;
    });
...
const CreateTrip = () => {
  ...
  const onGenerateTrip = async () => {
    ...
    if (noOfDays > 5 && (!location || !budget || !traveler)) {
    ...
    // Attempt to extract clean JSON from AI output
  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10">
      ...
      <div>
        <h2 className="text-xl my-3 font-medium flex justify-start">What is your Budget?</h2>
